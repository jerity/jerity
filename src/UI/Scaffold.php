...
EOHTML;
   ...
   *
   * @param  \Jerity\Form\Generator  $generator  The instance to which the 
   ...
   *
   * @return  Jerity\Form\Generator_Select
   */
  public function inputFromLinkedField(Form\Generator $generator, $table, $field, $linked_table) {
    $options = array();
   ...
   *                                       foreign key.
   *
   * @return  \Jerity\Form\Generator_Element
   *
   * @todo  Date/time field support
   * @todo  Decide what to do with BLOBs, BINARY, etc
   */
  public function inputFromField(Form\Generator $generator, $table, $field) {
   ...
   *                                             should be generated.
   * @param  string                  $action     The form type: create or 
   *                                             update.
   ...
   */
  protected function generateForm($table, $action, Form\Generator $generator = null, $primary_key=null) {
    if (is_null($generator)) {
      $generator = new Form\Generator(true);
    }
   ...
   * @return  \Jerity\Form\Generator  The generator with other fields added.
   */
  public function generateCreateForm($table, Form\Generator $generator = null) {
